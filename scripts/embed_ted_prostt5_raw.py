#!/usr/bin/env python3
"""
Stream a large TED FASTA, embed with ProstT5, and write raw 1024-dim embeddings.
...
It performs two passes:
  ...
  2) Stream, embed, and write results sequentially to disk.

Output directory files:
  - embeddings.npy: float16/float32, shape (N, 1024)
...
def process_batch(
    ...
    return domain_ids, pooled_tensor, label_idxs


def main():
    parser = argparse.ArgumentParser(
        description="Embed TED FASTA with ProstT5 and save raw embeddings"
    )
